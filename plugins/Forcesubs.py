...
async def forcesub(c, m):
    ...
    if UPDATE_CHANNEL:
        try:
            ...
            buttons = [[InlineKeyboardButton(text='✅ OFFICIAL CHANNEL ✅', url=f"https://t.me/joinchat/pYITM96MQSs3OTRl")]]
            if m.text:
            ...
            await m.reply_text(
                f"Hey {m.from_user.mention(style='md')} you need join My offical channel in order to use me 😉\n\n"
